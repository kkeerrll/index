...
<main>
  ...
  <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target=".multi-collapse" aria-expanded="false" aria-controls="multiCollapseExample3 multiCollapseExample2">Какая гарантия?</button>
</p>
<div class="row">
  <div class="col">
